...
import net.oyyq.dbflowtest.fragment.assist.PermissionsFragment;
import net.qiujuer.genius.res.Resource;
import net.qiujuer.genius.ui.compat.UiCompat;


public class LaunchActivity extends Activity implements PermissionsFragment.outerCallback {
    // Drawable
    ...
    @Override
    public void notifyPermission(boolean succeed) {
        if(succeed){
            if (Account.isLogin()) {
                MainActivity.show(this);
            } else {
