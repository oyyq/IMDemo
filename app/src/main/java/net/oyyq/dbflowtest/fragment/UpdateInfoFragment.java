...
import net.oyyq.dbflowtest.presenter.user.UpdateInfoContract;
import net.oyyq.dbflowtest.presenter.user.UpdateInfoPresenter;
...
public class UpdateInfoFragment extends PresenterFragment<UpdateInfoContract.Presenter>
    ...
    void onPortraitClick() {
        new GalleryFragment()
                ...
                })   //截止到这里, new出来一个GalleryFragment对象, 没有进入Fragmen#onCreateView, onStart, onResume的调用
