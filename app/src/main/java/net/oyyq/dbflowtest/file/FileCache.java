package net.oyyq.dbflowtest.file;
...
public class FileCache<Holder>{
    ...
    public FileCache(String baseDir, String ext, CacheListener<Holder> listener) {
        this.baseDir = new File(DemoApplication.getCacheDirFile(), baseDir);
        this.ext = ext;
    ...
    public void download(Holder holder, String path) {
        ...
        if (path.startsWith(DemoApplication.getCacheDirFile().getAbsolutePath())) {
            //回调-> 播放
