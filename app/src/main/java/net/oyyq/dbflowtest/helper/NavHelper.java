...
/**
 * when a Fragment is detached =>  onPause, onStop, onDestroyView
 * when a Fragment is removed =>  onPause, onStop, onDestroyView, onDestroy, onDetach
 * when attach a Fragment =>  onCreateView, onStart onResume
 * when add a Fragment => onAttach, onCreate, onCreateView, onStart onResume
 */
