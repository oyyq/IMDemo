...
public class AudioRecordHelper {
                    ...
                    try {
                        ...
                        if (bufferSize != AudioRecord.ERROR_BAD_VALUE) {
                            ...
                            if (recorder.getState() == AudioRecord.STATE_INITIALIZED) {
                                ...
                                // 所以是其一半的大小即可，很多人不注意这一点很容易导致多余内存消耗
    ...
    */
    ...
    public File record() {
        ...
        Lame lame = new Lame(audioRecorder.getSampleRate(), audioRecorder.getChannelCount(), audioRecorder.getSampleRate());
        // 构建一个输出流，定向到文件流上面
    ...
    /**
     * 停止录制语音, 线程异步执行录音, 埋点isCancel, & isDone
     * 传递一个参数标示是取消录音还是完成录音
     *
