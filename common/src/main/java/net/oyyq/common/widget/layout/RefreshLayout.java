...
public class RefreshLayout extends ViewGroup {
    ...
    // 刷新成功，显示500ms成功状态再滚动回顶部,  耗时800ms
...
//            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // ----- measure target -----
        // target占满整屏, target: CoordinatorLayout,
        ...
        if (!hasMeasureHeader) { // 防止header重复测量
            ...
            totalDragDistance = headerHeight - 20;   // 需要pull这个距离才进入松手刷新状态, headerHeight > 60
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                super.dispatchTouchEvent(ev);           //先将事件向child view传递
                return true;
